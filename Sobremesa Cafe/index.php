...
<html lang="en">
  ...
  <body>
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      ...
      <g>
        <!-- Adding text behind the logo -->
        <text x="10" y="40" font-family="Arial" font-size="24" fill="lightgray" opacity="0.5">
          Login
        </text>
        <!-- Using the person logo -->
        <use xlink:href="#link" x="10" y="10" width="24" height="24" />
      </g>
    </svg>
      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-3 text-center text-sm-start">
            <div class="main-logo">
              <a href="index.php">
                <img src="images/logo.png" alt="logo" class="img-fluid" style="width: 241px;height:54px;">
              </a>
            </div>
          </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="images/images/AMERICANO.jpg" class="img-fluid">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="images/images/AMERICANO.jpg"  class="tab-image">
                          </a>
                        </figure>
                        <h3>AMERICANO</h3>
