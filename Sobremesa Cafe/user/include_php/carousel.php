  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="row justify-content-center align-items-center ">
        ...
        <div class="col-md-5">
          <img class=" " style="width:500px;height:750px;" src="/Sobremesa Cafe/user/images/foods&drinks/BEEF TAPA.png"
            alt="Food Image">
        </div>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="row justify-content-center align-items-center">
        ...
        <div class="col-md-5">
          <img class="" src="/Sobremesa Cafe/user/images/foods&drinks/BACON CHEESE.png" alt="Food Image"
    ...
    <div class="carousel-item">
      <div class="row justify-content-center align-items-center">
        ...
        <div class="col-md-5">
          <img class="" src="/Sobremesa Cafe/user/images/foods&drinks/CHICKEN ALFREDO.png" alt="Food Image"
            style="width:500px;height:750px">
        </div>
      </div>
    </div>
